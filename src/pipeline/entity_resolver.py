...
INVESTOR_ALIASES: dict[str, str] = {
    ...
    "Stripe": "Stripe",
    "Elad Gil": "Elad Gil",
    # Crypto-focused VCs (common in DefiLlama data)
    "Hack VC": "Hack VC",
    "HackVC": "Hack VC",
    ...
    "OKEx Blockdream Ventures": "OKX Ventures",
    "Spartan Group": "Spartan",
    "Spartan Capital": "Spartan",
    ...
    "Solana Foundation": "Solana Ventures",
    ...
    "BlockchainCapital": "Blockchain Capital",
    "Alameda Research": "Alameda Research",
    "FTX Ventures": "FTX Ventures",
    # Additional general VCs
    ...
    "Earlybird Venture Capital": "Earlybird",
    "Earlybird": "Earlybird",
